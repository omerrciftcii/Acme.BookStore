...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p af24e296-d168-466e-9a13-23cd651e3be6
```

> `af24e296-d168-466e-9a13-23cd651e3be6` is the password of the certificate, you can change it to any password you want.
